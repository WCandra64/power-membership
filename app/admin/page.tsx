      ...
      <div className="flex gap-2 w-full overflow-x-auto scrollbar-hidden pb-2 px-6">
        {category.map((c, i) => (
          <div
            ...
            className={`flex flex-col gap-1 group ${c.isActive ? c.activeColor+" shadow-sm/40" : c.defaultColor} rounded-sm px-4 py-2 border-2 border-stroke cursor-pointer hover:${c.activeColor} hover:text-background`}
          >
            <div className="flex gap-2">
        ...
        <div className="flex flex-col items-center justify-end gap-2 w-full h-full">
          {
            ...
            Array.from({ length: 10 }).map((_, i) => (
              <Link
                ...
                className="flex items-center gap-4 w-full bg-background rounded-sm shadow-md p-4 border-2 border-stroke"
              >
